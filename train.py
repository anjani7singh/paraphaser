...
# load the dataset:
train = pd.read_csv("./paraphrase_train.csv")
val=pd.read_csv("./paraphrase_val.csv")
...
args_dict.update({'data_dir': './', 'output_dir': './t5/', 'num_train_epochs':1,'max_seq_length':50})
