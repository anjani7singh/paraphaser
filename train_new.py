...
class T5FineTuner(pl.LightningModule):
    ...
    def train_dataloader(self):
        train_dataset = get_dataset(tokenizer=self.tokenizer, type_path="paraphrase_train", args=self.hparams)
    ...
    def val_dataloader(self):
        val_dataset = get_dataset(tokenizer=self.tokenizer, type_path="paraphrase_val", args=self.hparams)
...
args_dict = dict(
    ...
    model_name_or_path='ramsrigouthamg/t5-large-paraphraser-diverse-high-quality',
    tokenizer_name_or_path='ramsrigouthamg/t5-large-paraphraser-diverse-high-quality',
    max_seq_length=512,
    learning_rate=3e-4,
    weight_decay=0.0,
    adam_epsilon=1e-8,
...
train_path = "./paraphrase_train.csv"
...
class ParaphraseDataset(Dataset):
    def __init__(self, tokenizer, data_dir, type_path, max_len=256):
        ...
        self.source_column = "original"
        self.target_column = "rewrite"
...
dataset = ParaphraseDataset(tokenizer, './', 'paraphrase_val', 256)
